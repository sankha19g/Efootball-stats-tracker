                    ...
                    <div className="flex-1 p-8 overflow-y-auto no-scrollbar space-y-8">
                        ...
                        {activeTab === 'card' && (
                            <div className="animate-fade-in space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        {[
                                            ...
                                            >
                                                ...
                                                <div className={`w-9 h-5 rounded-full relative transition-all duration-300 ${settings[item.id] !== false ? 'bg-ef-accent' : 'bg-white/10'}`}>
                                ...
                                <section className="space-y-4 pt-6 border-t border-white/5">
                                    <h4 className="text-[9px] font-black text-ef-accent uppercase tracking-widest pl-1">Grid Display Config</h4>
                                    <div className="bg-white/[0.03] p-6 rounded-[2rem] border border-white/5 space-y-4">
                                        ...
                                        >
                                            ...
                                            <div className={`w-9 h-5 rounded-full relative transition-all duration-300 ${settings.showStats !== false ? 'bg-ef-accent' : 'bg-white/10'}`}>
                        ...
                        {activeTab === 'general' && (
                            <div className="animate-fade-in space-y-10">
                                ...
                                <section className="space-y-4">
                                    <h4 className="text-[9px] font-black text-ef-accent uppercase tracking-widest pl-1">Optimization</h4>
                                    <button
                        ...
                        {activeTab === 'branding' && (
                            <div className="animate-fade-in space-y-6">
                                <section className="space-y-4">
                                    <h4 className="text-[9px] font-black text-ef-accent uppercase tracking-widest pl-1">Personalization</h4>
                                    <div
                                        onDragOver={handleDragOver}
                                        onDragLeave={handleDragLeave}
                                        onDrop={handleDrop}
                                        className={`relative flex flex-col items-center justify-center gap-6 bg-white/[0.02] p-10 rounded-[2.5rem] border-2 border-dashed transition-all group ${isDragging ? 'border-ef-accent bg-ef-accent/5' : 'border-white/5 hover:border-ef-accent/20'}`}
                                    >
                                        ...
                                        <div className="text-center space-y-2">
                                            <label className="cursor-pointer block">
                                                <span className="text-[10px] font-black text-ef-accent uppercase tracking-[0.2em] px-6 py-3 bg-ef-accent/10 rounded-xl border border-ef-accent/20 hover:bg-ef-accent hover:text-ef-dark transition-all inline-block">
                                                    Upload New Logo
                                                </span>
                        ...
                        {activeTab === 'maintenance' && (
                            <div className="animate-fade-in space-y-6">
                                <section className="space-y-4">
                                    <h4 className="text-[9px] font-black text-ef-accent uppercase tracking-widest pl-1">Database Repair</h4>
                                    <div className="bg-white/[0.03] p-8 rounded-[2rem] border border-white/5 space-y-8 flex flex-col items-center text-center">
                                        <div className="space-y-2">
                                        ...
                                        <div className="w-full max-w-[200px] flex flex-col gap-4">
                                            <button
                                                ...
                                                disabled={isFixing}
                                                className={`w-full py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all shadow-xl ${isFixing ? 'bg-white/10 text-white/20' : 'bg-ef-accent text-ef-dark hover:scale-105 active:scale-95'}`}
                                            >
                                            ...
                                            <div className="flex items-center justify-between px-2">
                                                ...
                                                <span className="text-[8px] font-black text-ef-accent uppercase tracking-widest">
