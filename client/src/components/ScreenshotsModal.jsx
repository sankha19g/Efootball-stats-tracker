...
const ScreenshotsModal = ({ user, onClose, showAlert, showConfirm }) => {
    ...
    const handleUpload = async (e) => {
        ...
        try {
            ...
            showAlert("Error", "Failed to upload screenshot", "danger");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleDelete = async (index, screenshot) => {
        ...
        showConfirm('Delete Screenshot', 'Remove this screenshot from your gallery?', async () => {
            try {
                // Optimistic update
                ...
                showAlert("Error", "Failed to delete screenshot", "danger");
