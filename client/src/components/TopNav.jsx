                ...
                <div className="flex items-center gap-4">
                    <button
                        onClick={() => {
                            if (isOpen) {
                                setIsOpen(false);
                            } else if (isSubView && !['leaderboard', 'squad-builder', 'quick-stats', 'squad-db', 'badges', 'settings', 'profile-stats', 'brochure', 'screenshots', 'quick-links', 'builds'].includes(view)) {
                                setView('list');
                            } else {
                                setIsOpen(true);
                            }
                    ...
                    >
                        ...
                        ) : (isSubView && !['leaderboard', 'squad-builder', 'quick-stats', 'squad-db', 'badges', 'settings', 'profile-stats', 'brochure', 'screenshots', 'quick-links', 'builds'].includes(view)) ? (
